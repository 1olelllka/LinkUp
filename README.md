...
1. Download all of the packages on `LinkUp! - 2.0-STABLE Release`
2. Then in terminal
```bash
unzip linkup_2.0-stable_frontend-and-files.zip
chmod +x ./unzip.sh # optional, if you encounter permission issues
./unzip.sh  # Or unzip.cmd if using Windows
docker compose up --build -d
```
